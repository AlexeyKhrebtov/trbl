...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md">
            <div class="card shadow">
                <img src="https://images.unsplash.com/photo-1529078155058-5d716f45d604?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=300&h=200&q=40" class="card-img" alt="OПO">
                <div class="card-img-overlay">
